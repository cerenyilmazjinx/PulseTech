...
#[derive(Debug)]
pub struct PulseTechProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PulseTechProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PulseTech processing");
    
    let mut processor = PulseTechProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PulseTechProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PulseTechProcessor::new(false);
